...
/* ================= Flow Wave — adapted for sectoraorg.com/staking =================
   Recolored to the site's blue brand (was mint-green in the source spec) and driven
   by the page's own real scroll instead of a dedicated art-only scroll host, so it
   sits as a persistent fixed backdrop behind the whole page — visible through the
   translucent panels, same way the hero pixel-grid canvas it replaces was. */

const reduced = window.matchMedia('(prefers-reduced-motion: reduce)').matches;

// ---- fixed parameters (recolored to Sectora blue) ----
...
void main(){
  ...
  // ---- scroll + pointer state (driven by the real page scroll, not an art-only host) ----
